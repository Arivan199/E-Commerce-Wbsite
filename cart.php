<?php
    ...
    //$user_products_query1="select supercoin from users";
    //$user_products_result1=mysqli_query($con,$user_products_query1) or die(mysqli_error($con));
    //$row = mysqli_fetch_assoc($user_products_result1);
    $sum=0;
    ...
    <body>
        <div>
            ...
            <div class="container">
                ...
                <?php  
                $supercoin=$sum/100;
                //$query="UPDATE users SET supercoin=$supercoin WHERE email=$email";
                
                //mysqli_query($con,$query) or die(mysqli_error($con));
                ?>
            </div>
            <center><h1><button>You have <?php echo $supercoin; ?> supercoins</button></h1></center>
